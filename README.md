...
Sign into your own Expo account locally; never paste passwords or tokens into chat or repository files.
...
After backend mobile authentication and real-device validation are complete, build the standalone app:
